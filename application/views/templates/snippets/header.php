        ...
        <div class="w-1/2 pr-0">
            <div class="flex relative inline-block float-right">
                ...
                <div class="relative text-sm">
                    ...
                    <img class="w-8 h-8 rounded-full mr-4" src="<?=$avatar;?>" alt="Avatar of User"> <span class="hidden md:inline-block">Hi, <?=$name;?> </span>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
            <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                <li class="mr-6 my-2 md:my-0">
                    <a href="home" class="block py-1 md:py-3 pl-1 align-middle text-blue-600 no-underline hover:text-gray-900 border-b-2 border-<?=($this->router->fetch_class() == 'home' ? 'blue-600' : 'white');?> hover:border-blue-600">
                        <i class="fas fa-home fa-fw mr-3 text-blue-<?=($this->router->fetch_class() == 'home' ? '600' : '400');?>"></i><span class="pb-1 md:pb-0 text-sm">Home</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <a href="archive" class="block py-1 md:py-3 pl-1 align-middle text-blue-600 no-underline hover:text-gray-900 border-b-2 border-<?=($this->router->fetch_class() == 'archive' ? 'blue-600' : 'white');?> hover:border-blue-600">
                        <i class="fas fa-archive fa-fw mr-3 text-blue-<?=($this->router->fetch_class() == 'archive' ? '600' : '400');?>"></i><span class="pb-1 md:pb-0 text-sm">Archive</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <a href="unarchive" class="block py-1 md:py-3 pl-1 align-middle text-blue-600 no-underline hover:text-gray-900 border-b-2 border-<?=($this->router->fetch_class() == 'unarchive' ? 'blue-600' : 'white');?> hover:border-blue-600">
